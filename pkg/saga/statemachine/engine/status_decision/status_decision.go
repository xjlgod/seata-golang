...
func (d DefaultStatusDecisionStrategy) DecideOnEndState(ctx context.Context, processContext process_ctrl.ProcessContext,
	...
	if statelang.RU == stateMachineInstance.CompensationStatus() {
		compensationHolder := utils.GetCurrentCompensationHolder(ctx, processContext, true)
...
func decideMachineCompensateStatus(ctx context.Context, stateMachineInstance statelang.StateMachineInstance, compensationHolder *utils.CompensationHolder) error {
